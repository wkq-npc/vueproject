<template>
    <div>
        <div class="fanhui" @click="fanhui"><span><b>&lt;</b></span>待支付订单</div>
...
<template #thumb class="img">
  ...
  <template #default="timeData">
    ...
    <van-button  class="zhifu" @click="lijizhifu(item.billId)">立即支付</van-button>
  </template>
</van-card>
...
export default {
    ...
    methods: {
        ...
        lijizhifu(id){
            ...
            // this.$router.push({ name:'zhifu' , query: {id:id} })
            // this.$router.push({ name:'zhifu' , query: {name:'qiao',code:id}})
